...
INSERT INTO `product` (`p_id`, `name`, `price`, `status`, `cold`, `hot`, `c_id`, `image`) VALUES
(100001, 'Latte', 8.90, 'available', 1, 1, 1001, 'icedlatte.jpg'),
(100002, 'Brown Sugar Pearl Milk Tea', 9.90, 'available', 1, 0, 1002, 'brownsugarpearlmilktea.jpg'),
(100003, 'Hazelnut Coffee', 12.90, 'available', 1, 1, 1001, '69d378fd89c65.jpg'),
(100004, 'Matcha Latte', 12.90, 'available', 1, 1, 1001, 'matchalatte.jpg'),
(100005, 'Mocha', 10.90, 'available', 1, 1, 1001, 'mocha.jpg'),
(100006, 'Signature Boba Milk Tea', 8.90, 'available', 1, 0, 1002, 'signaturebobamilktea.jpg'),
(100007, 'Signature Mixed Fruit Tea', 12.90, 'available', 1, 0, 1003, 'signaturemixedfruittea.png'),
(100008, 'Oolong Tea', 7.90, 'available', 1, 1, 1005, 'oolongtea.png'),
(100009, 'Signature Chocolate', 12.90, 'available', 1, 1, 1006, 'signaturechocolate.jpg'),
(100010, 'Cappuccino', 11.90, 'available', 1, 1, 1001, '69d394b15f100.jpg'),
(100011, 'Americano', 9.90, 'available', 1, 1, 1001, '69d394db1249a.jpg'),
(100012, 'Espresso', 11.90, 'available', 0, 0, 1001, '69d395061ea2d.jpg'),
(100013, 'Macchiato', 12.90, 'available', 1, 1, 1001, '69d395187cda9.jpg'),
(100014, 'Mango Milk Tea', 13.90, 'available', 1, 0, 1002, '69d39546543c4.jpg'),
(100015, 'Matcha Milk Tea', 11.90, 'available', 1, 0, 1002, '69d3956c94c15.jpg'),
(100016, 'Taro Milk Tea', 12.90, 'available', 1, 0, 1002, '69d39581e297d.jpg'),
(100017, 'Dark Chocolate Milk Tea', 13.90, 'available', 1, 0, 1006, '69d395a330b25.jpg'),
(100018, 'Strawberry Milk Tea', 13.90, 'available', 1, 0, 1002, '69d395e69b252.jpg'),
(100019, 'kopi', 2.50, 'available', 1, 1, 1001, '69d5c2bfdffce.jpg'),
(100020, 'Fruit Tea \'A\'', 9.85, 'available', 1, 0, 1003, '69e3bab322eb5.jpg'),
(100021, 'Filterd Tap Water A', 0.50, 'available', 1, 1, 1007, '69e3c371a9baf.jpg'),
(100022, 'Filtered Tap Water 2', 1.00, 'available', 1, 1, 1007, '69e3c39537aad.jpg');
...
(100007, 'f1966kk', 'F1966KK@GMAIL.COM', '01144444444', '2026-04-19 04:13:40', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'member', NULL, '69e3f2b2d7f02.jpg');
...
--
ALTER TABLE `address`
  MODIFY `d_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100009;

--
-- AUTO_INCREMENT for table `admin`
--
ALTER TABLE `admin`
  MODIFY `a_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1009;
...
--
ALTER TABLE `user`
  MODIFY `u_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100008;
